 ...
 * @Description :
 */
public class StatelessAuthcRealm extends AuthorizingRealm {
    @Resource
    ...
    public void setName(String name) {
        super.setName("StatelessAuthcRealm");
    }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        //签证信息
        CurrentUserDTO userDTO = statelessToken.getUserDTO();
        //使用缓存中的userToken和当前验证token进行对比
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(userDTO, userDTO.getUserToken(), getName());
